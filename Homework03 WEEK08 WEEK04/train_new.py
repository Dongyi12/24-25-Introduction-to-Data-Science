...
def main():
    ...
    # Adjust the value of n_components
    n_components = min(5, train_features.shape[1])  # Ensure that the feature dimension is not exceeded
    ...
    # If n_components=5, select the first two principal components for visualisation
